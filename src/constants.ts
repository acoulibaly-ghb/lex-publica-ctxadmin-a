...
Code de la commande publique, article L.1121-3
...
o soit par la résiliation pour l’avenir seulement du contrat, 
o soit par la réduction de sa durée, 
o ou encore par une pénalité financière.
**
...
*
    L’annulation d'un acte détachable d'un contrat n'implique pas nécessairement la nullité dudit contrat – Conseil d’État, 21 février 2011, Société Ophrys et communauté d'agglomération Clermont-communauté. Mais elle entraîne tout de même d’importantes conséquences que trois décisions ont soulignées :
      * Conseil d’État, 21 février 2011, Société Véolia propreté et autres ; Conseil d’État, 21 février 2011, Société Ophrys et communauté d'agglomération Clermont-communauté. Il appartient au juge de l'exécution du contrat, après avoir pris en considération la nature de l'illégalité commise, 
          o soit de décider que la poursuite de l'exécution du contrat est possible, éventuellement sous réserve de mesures de régularisation prises par la personne publique ou convenues entre les parties, 
          o soit, après avoir vérifié que sa décision ne portera pas une atteinte excessive à l'intérêt général, d'enjoindre à la personne publique de résilier le contrat, le cas échéant avec un effet différé, 
          o soit, eu égard à une illégalité d'une particulière gravité, d'inviter les parties à résoudre leurs relations contractuelles ou, à défaut d'entente sur cette résolution, à saisir le juge du contrat afin qu'il en règle les modalités s'il estime que la résolution peut être une solution appropriée.
      * Conseil d’État, 8 juin 2011, Commune de Divonne-les-Bains. Il appartient à la personne publique de déterminer, sous le contrôle du juge, les conséquences à tirer de l’annulation de l'acte détachable de la passation d'un contrat, compte tenu de la nature de l'illégalité affectant cet acte : 
          o s'il s'agit notamment d'un vice de forme ou de procédure propre à l'acte détachable et affectant les modalités selon lesquelles la personne publique a donné son consentement, celle-ci peut procéder à sa régularisation, indépendamment des conséquences de l'annulation sur le contrat lui-même ; 
          o elle peut ainsi, eu égard au motif d'annulation de l'acte détachable, adopter un nouvel acte d'approbation avec effet rétroactif, dépourvu du vice ayant entaché l'acte annulé.
...
o indemnité pour responsabilité de l'administration contractante, 
o indemnité en application des théories de l'équation financière, du fait du prince, de l'imprévision et des sujétions imprévues - Cf. infra B - L'influence des faits nouveaux.
o indemnité pour prestations supplémentaires indispensables effectuées spontanément.
**
b – Les obligations
 Sauf cas de force majeure, le cocontractant est tenu d'exécuter ses obligations contractuelles. Cette exécution doit être :  
o personnelle : la sous-traitance est subordonnée à l'agrément explicite ou tacite de l'administration contractante,
o intégrale,  
o effectuée dans les délais convenus.
 Principe :
...
--- FIN KNOWLEDGE BASE ---
`;
// À la fin du fichier constants.ts, APRÈS SYSTEM_INSTRUCTION

export const GLOSSARY_DATA = [
  {
    term: "Cour Internationale de Justice (CIJ)",
    definition: "Organe judiciaire principal des Nations Unies, établi en 1945. Siège à La Haye, aux Pays-Bas."
  },
  {
    term: "Différend",
    definition: "Désaccord sur un point de droit ou de fait (Affaire Mavrommatis, 1924)."
  },
  {
    term: "Avis consultatif",
    definition: "Opinion juridique donnée par la CIJ sans force obligatoire."
  },
  {
    term: "Arrêt",
    definition: "Décision judiciaire rendue par la CIJ avec force obligatoire pour les parties."
  },
  {
    term: "Juge ad hoc",
    definition: "Juge désigné temporairement par une partie à un différend devant la CIJ."
  },
  {
    term: "Exception préliminaire",
    definition: "Moyen soulevé avant l'examen du fond pour contester la compétence de la Cour."
  },
  {
    term: "Mesures conservatoires",
    definition: "Mesures provisoires ordonnées par la CIJ pour préserver les droits des parties."
  },
  {
    term: "Responsabilité internationale",
    definition: "Obligation pour un État de réparer le préjudice causé par un fait illicite."
  }
];
